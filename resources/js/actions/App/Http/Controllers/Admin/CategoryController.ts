 ...
 * @see app/Http/Controllers/Admin/CategoryController.php:33
 * @route '/admin/categories'
 */
 ...
 * @see app/Http/Controllers/Admin/CategoryController.php:40
 ...
 * @see app/Http/Controllers/Admin/CategoryController.php:47
 * @route '/admin/categories/{category}'
 */
