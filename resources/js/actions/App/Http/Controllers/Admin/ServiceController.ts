 ...
 * @see app/Http/Controllers/Admin/ServiceController.php:32
 ...
 * @see app/Http/Controllers/Admin/ServiceController.php:72
 ...
 * @see app/Http/Controllers/Admin/ServiceController.php:91
 ...
 * @see app/Http/Controllers/Admin/ServiceController.php:116
 * @route '/admin/services/{service}'
 */
 ...
 * @see app/Http/Controllers/Admin/ServiceController.php:123
 * @route '/admin/services/{service}'
 */
...
/**
* @see \App\Http\Controllers\Admin\ServiceController::reorder
 * @see app/Http/Controllers/Admin/ServiceController.php:130
...
/**
* @see \App\Http\Controllers\Admin\ServiceController::toggleActive
 * @see app/Http/Controllers/Admin/ServiceController.php:147
 * @route '/admin/services/{service}/toggle-active'
 */
export const toggleActive = (args: { service: number | { id: number } } | [service: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
...
toggleActive.definition = {
    methods: ["patch"],
    url: '/admin/services/{service}/toggle-active',
 ...
 * @route '/admin/services/{service}/toggle-active'
 */
toggleActive.url = (args: { service: number | { id: number } } | [service: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { service: args }
    }
 ...
 * @route '/admin/services/{service}/toggle-active'
 */
toggleActive.patch = (args: { service: number | { id: number } } | [service: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: toggleActive.url(args, options),
    method: 'patch',
})
 ...
 * @route '/admin/services/{service}/toggle-active'
 */
    const toggleActiveForm = (args: { service: number | { id: number } } | [service: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/services/{service}/toggle-active'
 */
        toggleActiveForm.patch = (args: { service: number | { id: number } } | [service: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: toggleActive.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const ServiceController = { index, create, store, show, edit, update, destroy, reorder, toggleActive }
